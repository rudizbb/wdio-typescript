class FilterMenuObject {
  ...
  public get searchButton() { return browser.element(this._searchButton); }
  public get secondLineFilters() { return browser.element(this._secondLineFilters); }
  public get firstLineFilters() { return browser.element(this._firstLineFilters); }
  public get filterOption() { return browser.element(this._filterOption); }
...
export const FilterMenu = new FilterMenuObject();
