class LoginPageObject {
  ...
  public get usernameBox() {
    return browser.element(this._usernameBox);
  }
  public get passwordBox() {
    return browser.element(this._passwordBox);
  }
  public get loginButton() {
    return browser.element(this._submit);
  }
  public get logoutButton() {
    return browser.element("//i[@class='icon-2x icon-signout']");
  }
  public get successMessage() {
    return browser.element(this._successMessage);
  }
  public get errorMessage() {
    return browser.element(this._errorMessage);
  }
  public get username() {
    return browser.element(this._username);
  }
  public get password() {
    return browser.element(this._password);
  }
  public get form() {
